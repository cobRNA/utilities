...
while (<GFF>){
	...
	$_=~s/("antisense_RNA")|("non_coding")|("bidirectional_promoter_lncrna")|("bidirectional_promoter_lncRNA")|("macro_lncRNA")|("lincRNA")|("processed_transcript")|("sense_intronic")|("sense_overlapping")/"lncRNA"/g;
